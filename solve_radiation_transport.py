...
from src.fixed_point import source_iteration, test_quad_sweep, source_iteration_diffusion
...
if __name__ == "__main__":
    ...
    n_angles = 50
    # test_quad_sweep(n_angles, m, inp)
    ...
    # test_quad_sweep(psi_diffusion, n_angles, m, inp)
    plt.legend()
    plt.show()
